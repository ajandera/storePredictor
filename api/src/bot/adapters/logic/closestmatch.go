...
func generator(match *closestMatch, text string) mr.GenerateFunc[any] {
...
func mapper(match *closestMatch) mr.MapperFunc[any, any] {
	return func(data interface{}, writer mr.Writer[any], cancel func(error)) {
...
func reducer(match *closestMatch) mr.ReducerFunc[any, any] {
	return func(input <-chan interface{}, writer mr.Writer[any], cancel func(error)) {
		tops := newTopScoreQuestions(match.tops)
